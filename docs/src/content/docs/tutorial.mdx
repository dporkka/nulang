...
Spawn an actor, send it messages with `!`, and query it with `ask`:
...
perform IO.print(perform Int.to_string(result))  // 2
```
...
Browse the full [API Reference](https://github.com/dporkka/nulang/blob/main/docs/api.md) or explore the [examples on GitHub](https://github.com/dporkka/nulang/tree/main/examples).
