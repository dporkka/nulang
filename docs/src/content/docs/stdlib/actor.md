---
title: "Actor Effect"
description: "Built-in Actor effect operations (auto-generated from src/stdlib.rs)"
sidebar:
  label: "Actor"
editUrl: false
---
...
The `Actor` effect provides the following built-in operations, wired into the VM and runtime.
