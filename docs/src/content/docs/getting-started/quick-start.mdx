...
Run `python3 playground/server.py` from a repo checkout (it auto-detects a
built `nulang` binary) and open http://localhost:8080. A hosted version at
nulang.org/playground is coming soon.
:::
